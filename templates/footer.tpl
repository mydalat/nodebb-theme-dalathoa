	...
	<nav class="dlh-bottom-nav" component="dlh/bottom-nav">
		...
		<a class="dlh-bottom-nav-item" href="{relative_path}/recent" data-dlh-tab="recent">
			<span class="dlh-i dlh-i-20"><svg viewBox="0 0 24 24"><path d="M2 3h6a4 4 0 014 4v14a3 3 0 00-3-3H2z"/><path d="M22 3h-6a4 4 0 00-4 4v14a3 3 0 013-3h7z"/></svg></span>
			Bài viết
		</a>
